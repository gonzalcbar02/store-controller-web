...
export default function CreateProjectView() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      setSubmitMessage({
        type: "error",
        text: error.message || "Error al crear el producto. Por favor, intenta de nuevo.",
      })
    } finally {
      setIsLoading(false)
    }
    ...
    <>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          ...
          <p className="text-2xl font-light text-gray-500 mt-5">Llena el siguiente formulario para crear un producto</p>
        </div>
      ...
      <form className="mt-10 bg-white shadow-lg rounded-lg p-10" onSubmit={handleSubmit(onSubmit)}>
        ...
        {userEmail && (
          <div className="mb-6 p-4 rounded-md bg-blue-50 border border-blue-200 text-blue-800">
            Creando producto para el usuario: {userEmail}
          </div>
        )}
        ...
        {!userEmail && (
          <div className="mb-6 p-4 rounded-md bg-yellow-50 border border-yellow-200 text-yellow-800">
            No se ha detectado un usuario con sesión iniciada. Por favor, inicie sesión antes de crear un producto.
          </div>
        )}
        ...
        <div className="space-y-6">
          ...
          <div className="mt-8">
            ...
            <div className="max-w-sm rounded-lg overflow-hidden shadow-lg border border-gray-200">
              ...
              <div className="px-4 py-3">
                <div className="font-bold text-lg mb-1">{watch("name") || "Producto"}</div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className={`font-bold py-3 px-10 text-lg cursor-pointer transition-colors rounded ${isLoading || !userEmail || !selectedFile
